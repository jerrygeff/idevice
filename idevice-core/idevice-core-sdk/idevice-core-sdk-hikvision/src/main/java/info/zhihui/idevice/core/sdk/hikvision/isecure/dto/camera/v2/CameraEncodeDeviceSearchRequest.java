...
public class CameraEncodeDeviceSearchRequest extends ISecureJsonPageRequest<CameraEncodeDeviceSearchResponse> {
    private static final String VERSION = "v2";
    private static final String API_URL = String.format(ISecureCameraConstant.CAMERA_ENCODE_DEVICE_SEARCH, VERSION);
    ...
    private CameraEncodeDeviceSearchRequest(String name, List<String> regionIndexCodes, Boolean isSubRegion,
    ...
    @Override
    public Class<CameraEncodeDeviceSearchResponse> getResponseClass() {
        return CameraEncodeDeviceSearchResponse.class;
    }
